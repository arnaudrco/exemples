...
class LoRaApp:
    def __init__(self, root):
        self.root = root
        self.root.title("E220-900-T22D LoRa UART")
        self.ser = None
        self.at_mode = False
        ...
        self.freq_entry.insert(0, "868200000")
        self.freq_entry.pack()

        tk.Label(root, text="Adresse destinataire (0-FFFF) :").pack()
