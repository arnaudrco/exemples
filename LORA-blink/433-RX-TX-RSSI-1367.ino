...
#define OLED_RESET   -1
#define PLUS   D4
#define LIGNES   130 // nombre approximatifs de characteres  sur écran
...
void setup() {
    ...
    tm.clear();
    tm.setBrightness(4); // 0 a7
    tm.showNumberDec(0, false); // Expect: ___0
...
void loop() {
  ...
  if (packetSize) {
      ...
      int sss= LoRa.packetRssi();
         ...
         tm.showNumberDec(sss, false); // Expect: ___0
